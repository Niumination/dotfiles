...
alias nswitch="sudo nixos-rebuild switch --flake /etc/nixos#zaryu"
alias nswitchu="sudo nix flake update --flake /etc/nixos; and sudo nixos-rebuild switch --flake /etc/nixos#zaryu --upgrade"
